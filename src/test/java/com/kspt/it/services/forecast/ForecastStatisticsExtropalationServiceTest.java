...
public class ForecastStatisticsExtropalationServiceTest {
    ...
    @Test
    public void testExtrapolateStatistics() throws Exception {
        ...
        List<Pair<Float,Date>> outputList = ForecastStatisticsExtropalationService.extrapolateStatistics(inputList,5);
