...
create table supplier_dimensions (
  ...
  store_id                  integer,
  cash_machine_id           integer,
  constraint uq_supplier_dimensions_cash_machine_id unique (cash_machine_id),
...
alter table supplier_dimensions add constraint fk_supplier_dimensions_cashMachine_9 foreign key (cash_machine_id) references cash_machines (id) on delete restrict on update restrict;
create index ix_supplier_dimensions_cashMachine_9 on supplier_dimensions (cash_machine_id);
